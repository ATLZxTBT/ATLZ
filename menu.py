...
novo_aluno = input(f"\033[1mNome do novo aluno: \033[0m")
# Repete apenas a nota if nota == wrong
while True:
    try:
...
print(f"--==|[{novo_aluno} com nota {nota_novo_aluno} foi \033[31madicionado\033[31m no BANDO DE DADOS]|==--\n")
